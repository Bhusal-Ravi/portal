...
function NotAuthorized() {
  ...
  <div className="min-h-screen bg-white px-6 pt-24 pb-10">
    <div className="max-w-md mx-auto border border-gray-200 rounded-2xl p-6 shadow-sm text-center">
      <p className="text-xs text-gray-400 uppercase tracking-widest mb-2">Access</p>
      <h1 className="text-3xl font-semibold text-gray-900 tracking-tight mb-4">Not Authorized</h1>
      <p className="text-sm text-gray-600 mb-2">You are not authorized to perform this action.</p>
